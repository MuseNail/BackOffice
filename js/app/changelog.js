...
const CHANGELOG = [
  { v: '0.48.0', items: [
    { icon: 'paid', t: 'Honest per-invoice profit, with fees split the right way', d: 'Each invoice now shows a profit breakdown — revenue, job expenses, card fee absorbed, payout fee, profit and profit %, plus how much processing fee you passed to the customer. Invoice2go card fees are now split by who paid them: a fee a customer covered (surcharge) nets out of income and does NOT cut your profit, while a fee you absorbed is booked to cost of goods and does. The Post-payments screen has the two matching fee-account pickers.' },
  ] },
  { v: '0.47.0', items: [
