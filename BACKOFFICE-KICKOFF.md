...
> **Status: BUILT THROUGH M12 — v0.14.0** (v0.12.0 LIVE at `musenail.github.io/BackOffice/`; v0.13.0+v0.14.0 add the Muse sync inbound + the QuickBooks IIF export — need a Pages push, `wrangler deploy`, and the `SYNC_TOKEN` secret). The Progress log at the bottom of this file is the build record. Remaining: M13.
